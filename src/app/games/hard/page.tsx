...
const hardConfig: GameConfig = {
  type: 'hard',
  wordLength: 6,
  maxAttempts: 5 // Fewer attempts to make it harder
}

const TUTORIAL_SHOWN_KEY = 'hard-tutorial-shown'

export default function HardWordle() {
  ...
  const {
    ...
    markCompleted,
    loadPuzzle
  } = usePuzzleHistory('hard', HARD_WORDS.length)
  
  // Get today's solution based on the puzzle number
  const solution = HARD_WORDS[(currentPuzzle.number - 1) % HARD_WORDS.length]
    ...
    <div className="max-w-lg mx-auto px-4 py-8 flex flex-col items-center">
      <div className="w-full flex justify-between items-center mb-4">
        <div className="flex items-center">
          ...
          <h1 className="text-3xl font-bold">Hard Mode</h1>
        </div>
        <div className="flex">
          <button
      ...
      <div className="text-center mb-4 w-full">
        <h2 className="text-lg font-medium">Hard Wordle #{currentPuzzle.number}</h2>
      ...
      <div className="flex flex-col items-center w-full">
        <Grid
          ...
          wordLength={hardConfig.wordLength}
        />
